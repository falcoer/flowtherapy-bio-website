...
expect(app.includes('assets/alpaga1-nu.png') && app.includes('assets/alpaga2-nu.png') && app.includes('assets/alpaga3-nu.png'), 'le hero doit utiliser les alpagas officiels nus');
